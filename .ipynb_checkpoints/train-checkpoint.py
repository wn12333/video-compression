...
def train_video_loader(path="/root/autodl-tmp/data/Vimeo90K/00001"):
    videos = []
...
def prepare_train_data(gop_video_batch):
    ...
    for gop_ims in gop_video_batch:
        ...
        # print("gop_split的长度", len(gop_split))
...
def save_all_model(model):
    ...
    torch.save(state,"-all-model-compression.pth")
...
def main():   
    ...
    for minibatch_processed in range(1,total_train_step+1):
        ...
        if minibatch_processed % train_step == 0:
            ...
            # print("Iterations:", minibatch_processed)
            # print("Distortion loss:", step_distortion_loss / train_step)
            # print("Rate loss:", step_rate_loss / train_step)
            # print("Train loss:", step_train_loss / train_step)
            # print("Aux loss:", step_aux_loss / train_step)
            # print("**************")
